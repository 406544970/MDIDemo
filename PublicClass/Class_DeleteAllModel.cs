...
{
    public class Class_DeleteAllModel
    {
        #region 构造、析构函数
        public Class_DeleteAllModel()
        {
            class_MyBatisMap = new Class_MyBatisMap();
            class_SelectDataBase = new Class_InsertDataBase();
        ...
        /// 生成代码类型
        /// </summary>
        public Class_InsertDataBase class_SelectDataBase { get; set; }
...
8、【CONNECT】：HTTP / 1.1协议中预留给能够将连接改为管道方式的代理服务器")]
        ...
        #region 数据库链接属性
        public partial class Class_InsertDataBase
        {
        ...
        public partial class Class_Field
        {
            ...
            #region 前端
            public bool FrontSelect { get; set; }
            public bool IsMust { get; set; }
            public string LabelCaption { get; set; }
            public string CompomentType { get; set; }
