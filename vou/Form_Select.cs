...
namespace MDIDemo.vou
{
    public partial class Form_Select : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void SetCompoment()
        {
            ...
            class_SetTextEdit.SetTextEdit(this.textEdit22, Color.LightGreen);
            class_SetTextEdit.SetTextEdit(this.textEdit31, Color.LightGreen);
            class_SetTextEdit.SetTextEdit(this.textEdit41, Color.LightGreen);
            ...
            class_SetTextEdit.SetTextEdit(this.textEdit73, Color.LightGreen);
            class_SetTextEdit.SetTextEdit(this.textEdit82, Color.LightGreen);
            class_SetTextEdit.SetTextEdit(this.textEdit97, Color.LightGreen);
            class_SetTextEdit.SetTextEdit(this.textEdit95, Color.LightGreen);
            class_SetTextEdit.SetTextEdit(this.textEdit91, Color.LightGreen);
            class_SetTextEdit.SetTextEdit(this.textEdit93, Color.LightGreen);
        ...
        private void _SaveSelectToXml(bool IsDisplayLog, bool PageVersionSign = false)
        {
            ...
            if (index > 0)
            {
                ...
                Class_SelectAllModel.Class_Create class_Create = this.propertyGridControl4.SelectedObject as Class_Create;
                class_SelectAllModel.class_Create = class_Create;
                string tempString = null;
                tempString = Class_SQLiteOperator.GetUserId(class_SelectAllModel.class_Create.CreateDo);
                if (tempString != null)
                    class_SelectAllModel.class_Create.CreateDoId = tempString;
                tempString = Class_SQLiteOperator.GetUserId(class_SelectAllModel.class_Create.CreateMan);
                if (tempString != null)
                    class_SelectAllModel.class_Create.CreateManId = tempString;
                tempString = Class_SQLiteOperator.GetUserId(class_SelectAllModel.class_Create.CreateFrontDo);
                if (tempString != null)
                    class_SelectAllModel.class_Create.CreateFrontDoId = tempString;
                #endregion
        ...
        private void textEdit16_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                this.textEdit99.Text = Class_Tool.GetFirstCodeUpper(string.Format("{0}SelectInParam", (sender as TextEdit).Text));
