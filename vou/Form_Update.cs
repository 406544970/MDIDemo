        ...
        public void SetSelectAllMode(string xmlFileName)
        {
            try
            {
                ...
                if (class_UpdateAllModel.class_SubList.Count > index)
                {
                    ...
                    this.checkEdit1.Checked = class_UpdateAllModel.class_SubList[index].IsAddXmlHead;
                    ...
                    this.checkEdit10.Checked = class_UpdateAllModel.class_SubList[index].ControlMainCode;
        ...
        private void _SaveSelectToXml(bool IsDisplayLog)
        {
            ...
            if (index > 0)
            {
                ...
                if (this.gridControl1.MainView.RowCount > 0)
                {
                    ...
                    class_UpdateAllModel.class_SubList[index].IsAddXmlHead = this.checkEdit1.Checked;
