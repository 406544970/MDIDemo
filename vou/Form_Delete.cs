...
namespace MDIDemo.vou
{
    ...
    {
        public Form_Delete(string skinName)
        {
            _iniSelect(skinName, null);
        }
        public Form_Delete(string skinName, string xmlFileName)
        {
        ...
        public void SetSelectAllMode(string xmlFileName)
        {
            try
            {
                ...
                {
                    case "MySql":
                        class_InterFaceDataBase = new Class_MySqlDataBase(class_DeleteAllModel.class_SelectDataBase.dataSourceUrl, class_DeleteAllModel.class_SelectDataBase.dataBaseName, class_DeleteAllModel.class_SelectDataBase.dataSourceUserName, class_DeleteAllModel.class_SelectDataBase.dataSourcePassWord, class_DeleteAllModel.class_SelectDataBase.Port);
                        break;
                    case "SqlServer 2017":
                        class_InterFaceDataBase = new Class_SqlServer2017DataBase(class_DeleteAllModel.class_SelectDataBase.dataSourceUrl, class_DeleteAllModel.class_SelectDataBase.dataBaseName, class_DeleteAllModel.class_SelectDataBase.dataSourceUserName, class_DeleteAllModel.class_SelectDataBase.dataSourcePassWord);
                        break;
                    default:
                        break;
                }
                class_InterFaceDataBase.SetClass_AllModel(class_DeleteAllModel);
                this.textEdit13.Text = class_DeleteAllModel.AllPackerName;
                this.checkEdit2.Checked = class_DeleteAllModel.IsAutoWard;
                this.memoEdit12.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.TestUnit);
                this.textEdit21.Text = class_DeleteAllModel.TestClassName;
                this.checkEdit19.Checked = class_DeleteAllModel.ReturnStructure;
                this.checkEdit20.Checked = class_DeleteAllModel.ReadWriteSeparation;

                #region 设置上次打开的Tab
                this.xtraTabControl1.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl1;
                this.xtraTabControl2.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl2;
                this.xtraTabControl3.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl3;
                this.xtraTabControl4.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl4;
                this.xtraTabControl6.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl6;
                this.xtraTabControl7.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl7;
                this.xtraTabControl9.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl9;
                this.xtraTabControl8.SelectedTabPageIndex = class_DeleteAllModel.class_WindowLastState.xtraTabControl8;
                #endregion
                int index = 0;
                #region 表
                if (class_DeleteAllModel.class_SubList.Count > index)
                {
                    this.textEdit14.Text = class_DeleteAllModel.class_SubList[index].MethodId;
                    this.textEdit15.Text = class_DeleteAllModel.class_SubList[index].MethodContent;
                    this.textEdit16.Text = class_DeleteAllModel.class_SubList[index].NameSpace;
                    this.memoEdit3.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].MapContent);
                    this.memoEdit4.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].SelectContent);
                    this.memoEdit5.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].ServiceInterFaceContent);
                    this.memoEdit6.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].ServiceImplContent);
                    this.memoEdit8.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].ModelContent);
                    this.memoEdit9.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].DTOContent);
                    this.memoEdit10.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].DAOContent);
                    this.memoEdit11.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].ControlContent);
                    this.memoEdit31.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].InPutParamContent);
                    this.textEdit100.Text = class_DeleteAllModel.class_SubList[index].ModelClassName;
                    this.textEdit17.Text = class_DeleteAllModel.class_Create.MethodId;
                    this.textEdit20.Text = class_DeleteAllModel.class_SubList[index].ServiceInterFaceReturnRemark;
                    this.textEdit47.Text = class_DeleteAllModel.class_SubList[index].ControlSwaggerValue;
                    this.textEdit46.Text = class_DeleteAllModel.class_SubList[index].ControlSwaggerDescription;
                    this.radioGroup9.SelectedIndex = class_DeleteAllModel.class_SubList[index].ServiceInterFaceReturnCount;
                    this.checkEdit10.Checked = class_DeleteAllModel.class_SubList[index].CreateMainCode;
                    this.panelControl4.Height = class_DeleteAllModel.class_SubList[index].PanelHeight;
                    this.memoEdit54.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].TestSql);

                    this.textEdit99.Text = class_DeleteAllModel.class_SubList[index].ParamClassName;
                    this.textEdit100.Text = class_DeleteAllModel.class_SubList[index].ModelClassName;
                    this.textEdit19.Text = class_DeleteAllModel.class_SubList[index].DtoClassName;
                    this.textEdit101.Text = class_DeleteAllModel.class_SubList[index].DaoClassName;
                    this.textEdit44.Text = class_DeleteAllModel.class_SubList[index].XmlFileName;
                    this.textEdit54.Text = class_DeleteAllModel.class_SubList[index].ControlRequestMapping;
                    this.textEdit102.Text = class_DeleteAllModel.class_SubList[index].ServiceInterFaceName;
                    this.textEdit103.Text = class_DeleteAllModel.class_SubList[index].ServiceClassName;
                    this.textEdit23.Text = class_DeleteAllModel.class_SubList[index].FeignInterFaceClassName;
                    this.textEdit4.Text = class_DeleteAllModel.class_SubList[index].FeignInterFaceHystricClassName;
                    this.textEdit24.Text = class_DeleteAllModel.class_SubList[index].FeignControlClassName;
                    this.memoEdit14.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].FeignInterFaceContent);
                    this.memoEdit15.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].FeignInterFaceHystricContent);
                    this.memoEdit16.Text = Class_Tool.UnEscapeCharacter(class_DeleteAllModel.class_SubList[index].FeignControlContent);
                ...
                if (class_DeleteAllModel != null)
                {
                    this.propertyGridControl3.SelectedObject = class_DeleteAllModel.class_SelectDataBase;
                    this.propertyGridControl4.SelectedObject = class_DeleteAllModel.class_Create;
                    this.propertyGridControl5.SelectedObject = class_DeleteAllModel.class_MyBatisMap;
                    this.textEdit13.Text = class_DeleteAllModel.AllPackerName;
                    if (xmlFileName != null)
                    {
                        _getUseTable(false);
                        for (int i = 0; i < class_DeleteAllModel.class_SubList.Count; i++)
                        {
                            if (class_DeleteAllModel.class_SubList[i] != null)
                                this.AddUseTableData(class_DeleteAllModel.class_SubList[i].TableName, class_DeleteAllModel.class_SubList[i].AliasName, i, false);
                        }
                    }
                }
            }
        ...
        private void AddUseTableData(string TableName, string TableAlias, int PageSelectIndex, bool SelectSelectDefault)
        {
            ...
            switch (PageSelectIndex)
            {
                case 0:
                    {
                        this.gridControl1.DataSource = class_InterFaceDataBase.GetMainTableStruct<Class_DeleteAllModel>(TableName, PageSelectIndex, SelectSelectDefault);
                        textEdit1.Text = TableName;
                        if (class_DeleteAllModel.class_SubList.Count > PageSelectIndex && class_DeleteAllModel.class_SubList[PageSelectIndex].AliasName != null)
                            textEdit10.Text = class_DeleteAllModel.class_SubList[PageSelectIndex].AliasName;
                        else
        ...
        private void _getUseTable(bool ReSet)
        {
            try
            {
                ...
                foreach (string row in myTableNameList)
                {
                    ...
                    string AliasName = class_SQLiteOperator.GetTableAlias(class_DeleteAllModel.class_SelectDataBase.dataSourceUrl
                        , class_DeleteAllModel.class_SelectDataBase.dataBaseName, row);
                ...
                if (class_DeleteAllModel.LastSelectTableName != null)
                {
                    int LastIndex = myTableNameList.IndexOf(class_DeleteAllModel.LastSelectTableName);
        ...
        /// <returns></returns>
        private Class_DeleteAllModel.Class_Sub DataViewIntoClass(BandedGridView bandedGridView,
        ...
        {
            Class_DeleteAllModel.Class_Sub class_Sub = new Class_DeleteAllModel.Class_Sub();
            List<Class_DeleteAllModel.Class_Field> class_Fields = new List<Class_DeleteAllModel.Class_Field>();
        ...
        private bool _CheckToXml(bool IsMongodb)
        {
            ...
            if (IsOk)
            {
                if (class_DeleteAllModel.class_Create.MicroServiceName == null || class_DeleteAllModel.class_Create.MicroServiceName.Length == 0)
                {
            ...
            if (IsOk)
            {
                if (class_DeleteAllModel.class_Create.CreateMan == null || class_DeleteAllModel.class_Create.CreateMan.Length == 0)
                {
        ...
        private void _SaveSelectToXml(bool IsDisplayLog, bool PageVersionSign = false)
        {
            ...
            class_WindowType.XmlFileName = class_DeleteAllModel.class_Create.MethodId;
            ...
            if (this.gridControl1.MainView.RowCount > 0)
            {
                ...
                if (class_DeleteAllModel.class_SubList.Count > index)
                    class_DeleteAllModel.class_SubList[index] = class_Sub;
                else
            ...
            if (index > 0)
            {
                class_DeleteAllModel.AllPackerName = this.textEdit13.Text;
                class_DeleteAllModel.IsAutoWard = this.checkEdit2.Checked;
                class_DeleteAllModel.TestUnit = Class_Tool.EscapeCharacter(this.memoEdit12.Text);
                class_DeleteAllModel.TestClassName = this.textEdit21.Text;
                class_DeleteAllModel.ReturnStructure = this.checkEdit19.Checked;
                class_DeleteAllModel.ReadWriteSeparation = this.checkEdit20.Checked;

                #region 保存上次打开的Tab
                class_DeleteAllModel.class_WindowLastState.xtraTabControl1 = this.xtraTabControl1.SelectedTabPageIndex;
                class_DeleteAllModel.class_WindowLastState.xtraTabControl2 = this.xtraTabControl2.SelectedTabPageIndex;
                class_DeleteAllModel.class_WindowLastState.xtraTabControl3 = this.xtraTabControl3.SelectedTabPageIndex;
                class_DeleteAllModel.class_WindowLastState.xtraTabControl4 = this.xtraTabControl4.SelectedTabPageIndex;
                class_DeleteAllModel.class_WindowLastState.xtraTabControl6 = this.xtraTabControl6.SelectedTabPageIndex;
                class_DeleteAllModel.class_WindowLastState.xtraTabControl7 = this.xtraTabControl7.SelectedTabPageIndex;
                class_DeleteAllModel.class_WindowLastState.xtraTabControl8 = this.xtraTabControl8.SelectedTabPageIndex;
                class_DeleteAllModel.class_WindowLastState.xtraTabControl9 = this.xtraTabControl9.SelectedTabPageIndex;
                #endregion
                ...
                if (this.gridControl1.MainView.RowCount > 0)
                {
                    class_DeleteAllModel.class_SubList[index].MethodId = this.textEdit14.Text;
                    class_DeleteAllModel.class_SubList[index].MethodContent = this.textEdit15.Text;
                    class_DeleteAllModel.class_SubList[index].NameSpace = this.textEdit16.Text;
                    class_DeleteAllModel.class_SubList[index].MapContent = Class_Tool.EscapeCharacter(this.memoEdit3.Text);
                    class_DeleteAllModel.class_SubList[index].SelectContent = Class_Tool.EscapeCharacter(this.memoEdit4.Text);
                    class_DeleteAllModel.class_SubList[index].ServiceInterFaceContent = Class_Tool.EscapeCharacter(this.memoEdit5.Text);
                    class_DeleteAllModel.class_SubList[index].ServiceImplContent = Class_Tool.EscapeCharacter(this.memoEdit6.Text);
                    class_DeleteAllModel.class_SubList[index].ModelContent = Class_Tool.EscapeCharacter(this.memoEdit8.Text);
                    class_DeleteAllModel.class_SubList[index].DTOContent = Class_Tool.EscapeCharacter(this.memoEdit9.Text);
                    class_DeleteAllModel.class_SubList[index].DAOContent = Class_Tool.EscapeCharacter(this.memoEdit10.Text);
                    class_DeleteAllModel.class_SubList[index].ControlContent = Class_Tool.EscapeCharacter(this.memoEdit11.Text);
                    class_DeleteAllModel.class_SubList[index].InPutParamContent = Class_Tool.EscapeCharacter(this.memoEdit31.Text);
                    class_DeleteAllModel.class_SubList[index].ModelClassName = this.textEdit100.Text;
                    class_DeleteAllModel.class_SubList[index].ControlSwaggerValue = this.textEdit47.Text;
                    class_DeleteAllModel.class_SubList[index].ControlSwaggerDescription = this.textEdit46.Text;
                    class_DeleteAllModel.class_SubList[index].ServiceInterFaceReturnRemark = this.textEdit20.Text;
                    class_DeleteAllModel.class_SubList[index].ServiceInterFaceReturnCount = this.radioGroup9.SelectedIndex;
                    class_DeleteAllModel.class_SubList[index].PanelHeight = this.panelControl4.Height;
                    class_DeleteAllModel.class_SubList[index].TestSql = Class_Tool.EscapeCharacter(this.memoEdit54.Text);
                    class_DeleteAllModel.class_SubList[index].AliasName = this.textEdit10.Text;

                    class_DeleteAllModel.class_SubList[index].ParamClassName = this.textEdit99.Text;
                    class_DeleteAllModel.class_SubList[index].ModelClassName = this.textEdit100.Text;
                    class_DeleteAllModel.class_SubList[index].DtoClassName = this.textEdit19.Text;
                    class_DeleteAllModel.class_SubList[index].DaoClassName = this.textEdit101.Text;
                    class_DeleteAllModel.class_SubList[index].XmlFileName = this.textEdit44.Text;
                    class_DeleteAllModel.class_SubList[index].ControlRequestMapping = this.textEdit54.Text;
                    class_DeleteAllModel.class_SubList[index].ServiceInterFaceName = this.textEdit102.Text;
                    class_DeleteAllModel.class_SubList[index].ServiceClassName = this.textEdit103.Text;

                    class_DeleteAllModel.class_SubList[index].FeignInterFaceClassName = this.textEdit23.Text;
                    class_DeleteAllModel.class_SubList[index].FeignInterFaceHystricClassName = this.textEdit4.Text;
                    class_DeleteAllModel.class_SubList[index].FeignControlClassName = this.textEdit24.Text;
                    class_DeleteAllModel.class_SubList[index].FeignInterFaceContent = Class_Tool.EscapeCharacter(this.memoEdit14.Text);
                    class_DeleteAllModel.class_SubList[index].FeignInterFaceHystricContent = Class_Tool.EscapeCharacter(this.memoEdit15.Text);
                    class_DeleteAllModel.class_SubList[index].FeignControlContent = Class_Tool.EscapeCharacter(this.memoEdit16.Text);
                }
                #endregion
                ...
                Class_DeleteAllModel.Class_Create class_Create = this.propertyGridControl4.SelectedObject as Class_Create;
                class_DeleteAllModel.class_Create = class_Create;
                string tempString = null;
                tempString = Class_SQLiteOperator.GetUserId(class_DeleteAllModel.class_Create.CreateDo);
                if (tempString != null)
                    class_DeleteAllModel.class_Create.CreateDoId = tempString;
                tempString = Class_SQLiteOperator.GetUserId(class_DeleteAllModel.class_Create.CreateMan);
                if (tempString != null)
                    class_DeleteAllModel.class_Create.CreateManId = tempString;
                tempString = Class_SQLiteOperator.GetUserId(class_DeleteAllModel.class_Create.CreateFrontDo);
                if (tempString != null)
                    class_DeleteAllModel.class_Create.CreateFrontDoId = tempString;
                #endregion
        ...
        private void barButtonItem9_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (this.textEdit17.Text.Trim() != null)
            {
                ...
                if (class_PublicMethod.PushToRemote(this.textEdit17.Text.Trim()))
                {
                    ...
                    MessageBox.Show("没有需要PUSH到远程的最新代码！"
                    , "错误信息", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
        ...
        private void filterList()
        {
            ...
            foreach (string item in filterUseTable(this.searchControl1.Text.Length > 0 ? this.searchControl1.Text : null))
            {
                ...
                this.listBoxControl3.Items.Add(class_SQLiteOperator.GetTableAlias(class_DeleteAllModel.class_SelectDataBase.dataSourceUrl
                    , class_DeleteAllModel.class_SelectDataBase.dataBaseName, item));
            }
        ...
        {
            ToPage(class_DeleteAllModel.class_SubList[PageIndex].TableName, PageIndex);
            if (PageIndex > 0)
            {
        ...
        {
            int PageMaxIndex = class_DeleteAllModel.class_SubList.Count;
            switch (PageIndex)
            {
                case 0:
            ...
            {
                class_DeleteAllModel.class_SubList.RemoveAt(i);
            }
        ...
        {
            class_DeleteAllModel.class_SelectDataBase.GetDataBaseDefault();
        ...
        private void barButtonItem20_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                dataBaseName = class_DeleteAllModel.class_SelectDataBase.dataBaseName,
                databaseType = class_DeleteAllModel.class_SelectDataBase.databaseType,
                dataSourcePassWord = class_DeleteAllModel.class_SelectDataBase.dataSourcePassWord,
                dataSourceUrl = class_DeleteAllModel.class_SelectDataBase.dataSourceUrl,
                dataSourceUserName = class_DeleteAllModel.class_SelectDataBase.dataSourceUserName,
                Port = class_DeleteAllModel.class_SelectDataBase.Port
            };
        ...
        private void CreateCode()
        {
            ...
            if (class_InterFaceCreateCode.IsCheckOk(ref outMessage))
            {
                ...
                //5：生成代码
                #region 表
                if (class_DeleteAllModel.class_SubList.Count > PageIndex)
                {
                    // MAP
