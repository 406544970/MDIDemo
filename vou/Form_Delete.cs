        ...
        public void SetSelectAllMode(string xmlFileName)
        {
            try
            {
                ...
                if (class_DeleteAllModel.class_SubList.Count > index)
                {
                    ...
                    this.checkEdit1.Checked = class_DeleteAllModel.class_SubList[index].IsAddXmlHead;
                    ...
                    this.checkEdit10.Checked = class_DeleteAllModel.class_SubList[index].ControlMainCode;
        ...
        private void _SaveSelectToXml(bool IsDisplayLog)
        {
            ...
            if (index > 0)
            {
                ...
                if (this.gridControl1.MainView.RowCount > 0)
                {
                    ...
                    class_DeleteAllModel.class_SubList[index].IsAddXmlHead = this.checkEdit1.Checked;
