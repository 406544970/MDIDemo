...
{
    public partial class Form_Insert : DevExpress.XtraEditors.XtraForm
    {
        public Form_Insert(string skinName)
        {
            _iniSelect(skinName, null);
        }
        public Form_Insert(string skinName, string xmlFileName)
        {
        ...
        public void SetSelectAllMode(string xmlFileName)
        {
            try
            {
                ...
                if (class_InsertAllModel == null)
                    class_InsertAllModel = new Class_InsertAllModel();
                if (class_InsertAllModel.AllPackerName == null || class_InsertAllModel.AllPackerName.Length == 0)
                {
                    ...
                    if (class_AllParamSetUp != null)
                        class_InsertAllModel.AllPackerName = class_AllParamSetUp.AllPackageName;
                }
                ...
                this.textEdit13.Text = class_InsertAllModel.AllPackerName;
                this.checkEdit2.Checked = class_InsertAllModel.IsAutoWard;
                this.memoEdit12.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.TestUnit);
                this.textEdit21.Text = class_InsertAllModel.TestClassName;
                this.checkEdit19.Checked = class_InsertAllModel.ReturnStructure;
                this.checkEdit20.Checked = class_InsertAllModel.ReadWriteSeparation;

                #region 设置上次打开的Tab
                this.xtraTabControl1.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl1;
                this.xtraTabControl2.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl2;
                this.xtraTabControl3.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl3;
                this.xtraTabControl4.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl4;
                this.xtraTabControl6.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl6;
                this.xtraTabControl7.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl7;
                this.xtraTabControl9.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl9;
                this.xtraTabControl8.SelectedTabPageIndex = class_InsertAllModel.class_WindowLastState.xtraTabControl8;
                #endregion
                int index = 0;
                #region 表
                if (class_InsertAllModel.class_SubList.Count > index)
                {
                    ...
                    this.memoEdit4.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].SelectContent);
                    this.memoEdit5.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].ServiceInterFaceContent);
                    this.memoEdit6.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].ServiceImplContent);
                    this.memoEdit8.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].ModelContent);
                    this.memoEdit9.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].DTOContent);
                    ...
                    this.textEdit99.Text = class_InsertAllModel.class_SubList[index].ParamClassName;
                    this.textEdit100.Text = class_InsertAllModel.class_SubList[index].ModelClassName;
                    this.textEdit19.Text = class_InsertAllModel.class_SubList[index].DtoClassName;
                    this.textEdit101.Text = class_InsertAllModel.class_SubList[index].DaoClassName;
                    this.textEdit44.Text = class_InsertAllModel.class_SubList[index].XmlFileName;
                    this.textEdit54.Text = class_InsertAllModel.class_SubList[index].ControlRequestMapping;
                    this.textEdit102.Text = class_InsertAllModel.class_SubList[index].ServiceInterFaceName;
                    this.textEdit103.Text = class_InsertAllModel.class_SubList[index].ServiceClassName;

                    this.textEdit23.Text = class_InsertAllModel.class_SubList[index].FeignInterFaceClassName;
                    this.textEdit4.Text = class_InsertAllModel.class_SubList[index].FeignInterFaceHystricClassName;
                    this.textEdit24.Text = class_InsertAllModel.class_SubList[index].FeignControlClassName;
                    this.memoEdit14.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].FeignInterFaceContent);
                    this.memoEdit15.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].FeignInterFaceHystricContent);
                    this.memoEdit16.Text = Class_Tool.UnEscapeCharacter(class_InsertAllModel.class_SubList[index].FeignControlContent);
                ...
                if (class_InsertAllModel != null)
                {
                    this.propertyGridControl3.SelectedObject = class_InsertAllModel.class_SelectDataBase;
                    this.propertyGridControl4.SelectedObject = class_InsertAllModel.class_Create;
                    this.propertyGridControl5.SelectedObject = class_InsertAllModel.class_MyBatisMap;
                    this.textEdit13.Text = class_InsertAllModel.AllPackerName;
                    if (xmlFileName != null)
                    {
                        _getUseTable(false);
                        for (int i = 0; i < class_InsertAllModel.class_SubList.Count; i++)
                        {
                            if (class_InsertAllModel.class_SubList[i] != null)
                                this.AddUseTableData(class_InsertAllModel.class_SubList[i].TableName, class_InsertAllModel.class_SubList[i].AliasName, i, false);
                        }
                    }
                }
            }
        ...
        private void AddUseTableData(string TableName, string TableAlias, int PageSelectIndex, bool SelectSelectDefault)
        {
            ...
            switch (PageSelectIndex)
            {
                case 0:
                    {
                        this.gridControl1.DataSource = class_InterFaceDataBase.GetMainTableStruct<Class_InsertAllModel>(TableName, PageSelectIndex, SelectSelectDefault);
                        textEdit1.Text = TableName;
                        if (class_InsertAllModel.class_SubList.Count > PageSelectIndex && class_InsertAllModel.class_SubList[PageSelectIndex].AliasName != null)
                            textEdit10.Text = class_InsertAllModel.class_SubList[PageSelectIndex].AliasName;
                        else
        ...
        private void _getUseTable(bool ReSet)
        {
            try
            {
                ...
                foreach (string row in myTableNameList)
                {
                    ...
                    string AliasName = class_SQLiteOperator.GetTableAlias(class_InsertAllModel.class_SelectDataBase.dataSourceUrl
                        , class_InsertAllModel.class_SelectDataBase.dataBaseName, row);
                ...
                if (class_InsertAllModel.LastSelectTableName != null)
                {
                    int LastIndex = myTableNameList.IndexOf(class_InsertAllModel.LastSelectTableName);
        ...
        private bool _CheckToXml(bool IsMongodb)
        {
            ...
            if (IsOk)
            {
                if (class_InsertAllModel.class_Create.MicroServiceName == null || class_InsertAllModel.class_Create.MicroServiceName.Length == 0)
                {
            ...
            if (IsOk)
            {
                if (class_InsertAllModel.class_Create.CreateMan == null || class_InsertAllModel.class_Create.CreateMan.Length == 0)
                {
        ...
        private void _SaveSelectToXml(bool IsDisplayLog, bool PageVersionSign = false)
        {
            ...
            class_WindowType.XmlFileName = class_InsertAllModel.class_Create.MethodId;
            ...
            if (this.gridControl1.MainView.RowCount > 0)
            {
                ...
                if (class_InsertAllModel.class_SubList.Count > index)
                    class_InsertAllModel.class_SubList[index] = class_Sub;
                else
            ...
            if (index > 0)
            {
                class_InsertAllModel.AllPackerName = this.textEdit13.Text;
                class_InsertAllModel.IsAutoWard = this.checkEdit2.Checked;
                class_InsertAllModel.TestUnit = Class_Tool.EscapeCharacter(this.memoEdit12.Text);
                class_InsertAllModel.TestClassName = this.textEdit21.Text;
                class_InsertAllModel.ReturnStructure = this.checkEdit19.Checked;
                class_InsertAllModel.ReadWriteSeparation = this.checkEdit20.Checked;

                #region 保存上次打开的Tab
                class_InsertAllModel.class_WindowLastState.xtraTabControl1 = this.xtraTabControl1.SelectedTabPageIndex;
                class_InsertAllModel.class_WindowLastState.xtraTabControl2 = this.xtraTabControl2.SelectedTabPageIndex;
                class_InsertAllModel.class_WindowLastState.xtraTabControl3 = this.xtraTabControl3.SelectedTabPageIndex;
                class_InsertAllModel.class_WindowLastState.xtraTabControl4 = this.xtraTabControl4.SelectedTabPageIndex;
                class_InsertAllModel.class_WindowLastState.xtraTabControl6 = this.xtraTabControl6.SelectedTabPageIndex;
                class_InsertAllModel.class_WindowLastState.xtraTabControl7 = this.xtraTabControl7.SelectedTabPageIndex;
                class_InsertAllModel.class_WindowLastState.xtraTabControl8 = this.xtraTabControl8.SelectedTabPageIndex;
                class_InsertAllModel.class_WindowLastState.xtraTabControl9 = this.xtraTabControl9.SelectedTabPageIndex;
                #endregion
                ...
                if (this.gridControl1.MainView.RowCount > 0)
                {
                    ...
                    class_InsertAllModel.class_SubList[index].SelectContent = Class_Tool.EscapeCharacter(this.memoEdit4.Text);
                    class_InsertAllModel.class_SubList[index].ServiceInterFaceContent = Class_Tool.EscapeCharacter(this.memoEdit5.Text);
                    class_InsertAllModel.class_SubList[index].ServiceImplContent = Class_Tool.EscapeCharacter(this.memoEdit6.Text);
                    class_InsertAllModel.class_SubList[index].ModelContent = Class_Tool.EscapeCharacter(this.memoEdit8.Text);
                    class_InsertAllModel.class_SubList[index].DTOContent = Class_Tool.EscapeCharacter(this.memoEdit9.Text);
                    ...
                    class_InsertAllModel.class_SubList[index].ServiceInterFaceReturnCount = this.radioGroup9.SelectedIndex;
                    class_InsertAllModel.class_SubList[index].PanelHeight = this.panelControl4.Height;
                    class_InsertAllModel.class_SubList[index].TestSql = Class_Tool.EscapeCharacter(this.memoEdit54.Text);
                    class_InsertAllModel.class_SubList[index].AliasName = this.textEdit10.Text;

                    class_InsertAllModel.class_SubList[index].ParamClassName = this.textEdit99.Text;
                    class_InsertAllModel.class_SubList[index].ModelClassName = this.textEdit100.Text;
                    class_InsertAllModel.class_SubList[index].DtoClassName = this.textEdit19.Text;
                    class_InsertAllModel.class_SubList[index].DaoClassName = this.textEdit101.Text;
                    class_InsertAllModel.class_SubList[index].XmlFileName = this.textEdit44.Text;
                    class_InsertAllModel.class_SubList[index].ControlRequestMapping = this.textEdit54.Text;
                    class_InsertAllModel.class_SubList[index].ServiceInterFaceName = this.textEdit102.Text;
                    class_InsertAllModel.class_SubList[index].ServiceClassName = this.textEdit103.Text;

                    class_InsertAllModel.class_SubList[index].FeignInterFaceClassName = this.textEdit23.Text;
                    class_InsertAllModel.class_SubList[index].FeignInterFaceHystricClassName = this.textEdit4.Text;
                    class_InsertAllModel.class_SubList[index].FeignControlClassName = this.textEdit24.Text;
                    class_InsertAllModel.class_SubList[index].FeignInterFaceContent = Class_Tool.EscapeCharacter(this.memoEdit14.Text);
                    class_InsertAllModel.class_SubList[index].FeignInterFaceHystricContent = Class_Tool.EscapeCharacter(this.memoEdit15.Text);
                    class_InsertAllModel.class_SubList[index].FeignControlContent = Class_Tool.EscapeCharacter(this.memoEdit16.Text);
                }
                #endregion

                #region 保存属性框
                class_InsertAllModel.class_SelectDataBase = this.propertyGridControl3.SelectedObject as Class_InsertDataBase;
                class_InsertAllModel.class_MyBatisMap = this.propertyGridControl5.SelectedObject as Class_MyBatisMap;
                Class_InsertAllModel.Class_Create class_Create = this.propertyGridControl4.SelectedObject as Class_Create;
                class_InsertAllModel.class_Create = class_Create;
                string tempString = null;
                tempString = Class_SQLiteOperator.GetUserId(class_InsertAllModel.class_Create.CreateDo);
                if (tempString != null)
                    class_InsertAllModel.class_Create.CreateDoId = tempString;
                tempString = Class_SQLiteOperator.GetUserId(class_InsertAllModel.class_Create.CreateMan);
                if (tempString != null)
                    class_InsertAllModel.class_Create.CreateManId = tempString;
                tempString = Class_SQLiteOperator.GetUserId(class_InsertAllModel.class_Create.CreateFrontDo);
                if (tempString != null)
                    class_InsertAllModel.class_Create.CreateFrontDoId = tempString;
                #endregion

                if (class_PublicMethod.InsertToXml(class_InsertAllModel.class_Create.MethodId, class_InsertAllModel, PageVersionSign))
                {
                    if (IsDisplayLog)
                        this.DisplayText(string.Format("已将{0}方法【{1}】，保存到本地。", class_InsertAllModel.classType, class_InsertAllModel.class_Create.MethodId));
                }
            }
            else
            {
        ...
        private void filterList()
        {
            ...
            foreach (string item in filterUseTable(this.searchControl1.Text.Length > 0 ? this.searchControl1.Text : null))
            {
                ...
                this.listBoxControl3.Items.Add(class_SQLiteOperator.GetTableAlias(class_InsertAllModel.class_SelectDataBase.dataSourceUrl
                    , class_InsertAllModel.class_SelectDataBase.dataBaseName, item));
            }
        ...
        {
            ToPage(class_InsertAllModel.class_SubList[PageIndex].TableName, PageIndex);
            if (PageIndex > 0)
            {
        ...
        {
            int PageMaxIndex = class_InsertAllModel.class_SubList.Count;
            switch (PageIndex)
            {
                case 0:
            ...
            {
                class_InsertAllModel.class_SubList.RemoveAt(i);
            }
            //if (class_SelectAllModel.class_SubList.Count > PageIndex)
            //    class_SelectAllModel.class_SubList[PageIndex] = new Class_InsertAllModel.Class_Sub();
        }

        private void barButtonItem19_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            class_InsertAllModel.class_SelectDataBase.GetDataBaseDefault();
        ...
        private void barButtonItem20_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                dataBaseName = class_InsertAllModel.class_SelectDataBase.dataBaseName,
                databaseType = class_InsertAllModel.class_SelectDataBase.databaseType,
                dataSourcePassWord = class_InsertAllModel.class_SelectDataBase.dataSourcePassWord,
                dataSourceUrl = class_InsertAllModel.class_SelectDataBase.dataSourceUrl,
                dataSourceUserName = class_InsertAllModel.class_SelectDataBase.dataSourceUserName,
                Port = class_InsertAllModel.class_SelectDataBase.Port
            };
        ...
        private void textEdit16_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                this.textEdit99.Text = Class_Tool.GetFirstCodeUpper(string.Format("{0}InsertInParam", (sender as TextEdit).Text));
