    ...
    public partial class Form_Insert : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void _SaveSelectToXml(bool IsDisplayLog)
        {
            ...
            if (class_SelectAllModel.class_Create.MethodId == null)
            {
                ...
                this.Text = string.Format("INSERT：{0}", class_SelectAllModel.class_Create.MethodId);
                this.textEdit17.Text = class_SelectAllModel.class_Create.MethodId;
            ...
            if (index > 0)
            {
                ...
                if (class_PublicMethod.InsertToXml(class_SelectAllModel.class_Create.MethodId, class_SelectAllModel))
                {
                    if (IsDisplayLog)
